...
impl Default for UpdateMode {
    fn default() -> Self {
        // This build defaults to Disabled rather than Prompt: it is a local,
        // account-free build, and the upstream update endpoint would replace it
        // with the official package. Still changeable from Settings.
        UpdateMode::Disabled
    }
}

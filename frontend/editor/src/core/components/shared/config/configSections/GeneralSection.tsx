...
const GeneralSection: React.FC<GeneralSectionProps> = ({
  hideTitle = false,
  // This fork ships neither the proprietary module nor upstream's release feed: the banner
  // that invites enabling the former, and the check that would offer the latter as an
  // update to a different program, are both off by default here.
                ...
                <Text size="xs" c="dimmed">
                  {desktopUpdateMode.locked
                    ? t(
                        ...
                        "L'amministratore ha stabilito come vengono gestiti gli aggiornamenti su questo computer.",
                      )
                    : t(

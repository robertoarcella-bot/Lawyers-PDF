...
import { attestazioniOperationConfig } from "@app/hooks/tools/attestazioni/useAttestazioniOperation";
  ...
  return useMemo(() => {
    const allTools: ToolRegistry = {
      ...
      sharedSign: {
        ...
        // Needs accounts, server-side storage and email: none of which exist in the core build.
        hiddenFromToolList: true,
      },
      addText: {
        icon: (
      ...
      attestazioni: {
        ...
        name: t("home.attestazioni.title", "Attestazioni di conformità"),
        component: lazy(() => import("@app/tools/Attestazioni")),
        description: t(
          "home.attestazioni.desc",
          "Appone in coda ai documenti l'attestazione di conformità del difensore",
        ),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.SIGNING,
        synonyms: getSynonyms(t, "attestazioni"),
        maxFiles: -1,
        endpoints: ["append-text-page"],
        // The composer needs the main area, not the 300px side panel.
        workbench: "custom:attestazioni",
        badgeLabel: t("home.attestazioni.badge", "Forense"),
        operationConfig: asRegistryConfig(attestazioniOperationConfig),
        // Not a pipeline step: the wording comes from browser-local templates and the
        // document descriptions are typed per run, neither of which an automation can supply.
        supportsAutomate: false,
        automationSettings: null,
      },
      addStamp: {
